...
public class Testing {
        public static void main(String[] args) {
            double principal = 10000; // Principal amount of the loan
            double interestRate = 7.5; // Annual interest rate (in percentage)
            int repaymentPeriod = 12 * 1; // Repayment period in months (e.g. 5 years)
...
//                System.out.println("EMI: " + emi);System.out.println("Remaining Principal: " + (principal - emi + (principal * rpp)));
//                System.out.println();
